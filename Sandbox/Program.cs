...
namespace Sandbox
{
    class Program
    {
        ...
        {
            ConnectedMesh mesh = ConnectedMesh.Build(ImporterOBJ.Read(@"..\..\..\..\Tests\test-models\plot.obj"));
